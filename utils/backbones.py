...
# Import weights enums for newer torchvision versions
try:
    from torchvision.models import AlexNet_Weights, ResNet50_Weights, ResNet18_Weights, ResNet101_Weights, ResNeXt101_32X8D_Weights, VGG11_Weights, VGG19_Weights, VGG19_BN_Weights, Wide_ResNet50_2_Weights, Wide_ResNet101_2_Weights
    NEW_TORCHVISION = True
except ImportError:
    NEW_TORCHVISION = False

_BACKBONES = {
    "alexnet": "models.alexnet(weights=AlexNet_Weights.IMAGENET1K_V1)" if NEW_TORCHVISION else "models.alexnet(pretrained=True)",
    "bninception": 'pretrainedmodels.__dict__["bninception"]'
    '(pretrained="imagenet", num_classes=1000)',
    "resnet50": "models.resnet50(weights=ResNet50_Weights.IMAGENET1K_V1)" if NEW_TORCHVISION else "models.resnet50(pretrained=True)",
    "resnet50_random": "models.resnet50()",
    "resnet18": "models.resnet18(weights=ResNet18_Weights.IMAGENET1K_V1)" if NEW_TORCHVISION else "models.resnet18(pretrained=True)",
    "resnet18_random": "models.resnet18()",
    "resnet101": "models.resnet101(weights=ResNet101_Weights.IMAGENET1K_V1)" if NEW_TORCHVISION else "models.resnet101(pretrained=True)",
    "resnext101": "models.resnext101_32x8d(weights=ResNeXt101_32X8D_Weights.IMAGENET1K_V1)" if NEW_TORCHVISION else "models.resnext101_32x8d(pretrained=True)",
    ...
    "vgg11": "models.vgg11(weights=VGG11_Weights.IMAGENET1K_V1)" if NEW_TORCHVISION else "models.vgg11(pretrained=True)",
    "vgg19": "models.vgg19(weights=VGG19_Weights.IMAGENET1K_V1)" if NEW_TORCHVISION else "models.vgg19(pretrained=True)",
    "vgg19_bn": "models.vgg19_bn(weights=VGG19_BN_Weights.IMAGENET1K_V1)" if NEW_TORCHVISION else "models.vgg19_bn(pretrained=True)",
    "wideresnet50": "models.wide_resnet50_2(weights=Wide_ResNet50_2_Weights.IMAGENET1K_V1)" if NEW_TORCHVISION else "models.wide_resnet50_2(pretrained=True)",
    "wideresnet101": "models.wide_resnet101_2(weights=Wide_ResNet101_2_Weights.IMAGENET1K_V1)" if NEW_TORCHVISION else "models.wide_resnet101_2(pretrained=True)",
